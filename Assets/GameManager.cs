...
public class GameManager : MonoBehaviour
{
    ...
    [NonSerialized]
    public TemplateBank templateBank;
    [NonSerialized]
    public ConstructionPhase constructionPhase;

    [NonSerialized]
    public OfficePointer officePointer;
    ...
    public void GoToConstructionPhase()
    {
        ...
        void Setup(Scene arg0, LoadSceneMode loadSceneMode)
        {
            RefreshPointers();
    ...
    public void GoToPlanningPhase()
    {
        ...
        SceneManager.LoadScene("PlanningPhase");
